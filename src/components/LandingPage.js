...
const Landing = () => {
  ...
  return (
    <div className="container1">
      ...
      <h5 className="landing"> <span> Don't worry, we got you... </span> </h5>
      <p className="landing"> With us, you are able to create your profile and set up your sensor <br />
